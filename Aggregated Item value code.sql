...
WHERE TO_DATE(cus.ORDERDATE) BETWEEN '2022-06-27' AND '2024-05-26' --We can change the dates here based on the timeframe requirement
...
AND TO_DATE(cus.ORDERDATE) BETWEEN '2022-06-27' AND '2024-05-26' --We can change the dates here based on the timeframe requirement
